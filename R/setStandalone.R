...
#' \dontrun {
#' setStandalone(url="https://github.com/epiviz/epiviz.git", branch="master")
#' }
#' 
#' @export
setStandalone <- function(url="https://github.com/epiviz/epiviz.git", branch="master", local_path=NULL) {
  ...
  dput(params, file=epivizrStandalone:::.settings_file)
